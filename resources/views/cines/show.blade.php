...
<main class="container mx-auto mt-8 p-6 bg-white shadow-lg rounded-lg max-w-lg">
    ...
    <h2 class="text-4xl font-bold text-gray-800 mb-4"><?= htmlspecialchars($cine->localidad) ?></h2>

    <!-- Director -->
    <div class="mb-4">
        <h3 class="text-lg font-semibold text-gray-700">Director:</h3>
        <p class="text-gray-600"><?= htmlspecialchars($cine->clientes) ?></p>
    </div>

    <!-- Año -->
    <div class="mb-4">
        <h3 class="text-lg font-semibold text-gray-700">Año de estreno:</h3>
        <p class="text-gray-600"><?= htmlspecialchars($cine->peliculas_mostradas) ?></p>
    </div>

    <div class="text-center">
        <a href="/cines" class="inline-block bg-blue-600 text-white font-bold py-2 px-4 rounded hover:bg-blue-700 transition duration-300">
            Volver a la lista
        </a>
    </div>
</main>
