...
<div class="max-w-md mx-auto bg-white shadow-md rounded-lg p-6">
    ...
    <form action="/store" method="POST">
        <div class="mb-4">
            ...
            <input type="text" name="nombre" required class="mt-1 block w-full border border-gray-300 rounded-md p-2" placeholder="Enter film title">
        </div>
        ...
        <div class="mb-4">
            <label for="year" class="block text-sm font-medium text-gray-700">Sinopsis:</label>
            <input type="text" name="year" required class="mt-1 block w-full border border-gray-300 rounded-md p-2" placeholder="Enter release sinopsis">
        </div>
